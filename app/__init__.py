...
socketio = SocketIO(flask_app, async_mode='gevent', ping_timeout=10, ping_interval=5, cors_allowed_origins=app_config[config_name].SOCKETIO_CORS_ALLOWED_ORIGIN)
