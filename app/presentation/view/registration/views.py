...
table_configuration = {
    ...
    'template': [
        ...
        {'name': 'Status', 'data': 'status', 'order_by': Guest.status, 'orderable': True, 'width': '4%', 'visible': 'yes',
         "celledit": {"type": "select", "options": [["registered", "OK"], ["registered-overflow", "OK(O)"], ["waiting-list", "WACHT"], ["unregistered", "UIT"]]}},
        ...
        {'name': 'Notitie', 'data': 'note', 'order_by': Guest.note, 'orderable': True, 'width': '20%', 'celledit': {"type": 'text-confirmkey'}, 'visible': 'yes'},
        {'name': 'R', 'data': 'reg_ack_email_tx', 'order_by': Guest.reg_ack_email_tx, 'width': '1%', 'celledit': {"type": 'toggle'}, 'visible': 'no'},
        {'name': 'R', 'data': 'reg_ack_nbr_tx', 'order_by': Guest.reg_ack_nbr_tx, 'width': '1%', 'visible': 'no'},
        {'name': 'T', 'data': 'tsl_ack_email_tx', 'order_by': Guest.reg_ack_email_tx, 'width': '1%', 'celledit': {"type": 'toggle'}, 'visible': 'no'},
