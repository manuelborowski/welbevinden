...
table_configuration = {
    ...
    'template': [
        ...
        {'name': 'Telefoon', 'data': 'phone', 'order_by': Guest.phone, 'orderable': True, 'width': '6%', 'visible': False},
        {'name': 'Notitie', 'data': 'note', 'order_by': Guest.note, 'orderable': True, 'width': '20%', 'celledit': 'text', 'visible': True},
        {'name': 'R', 'data': 'reg_ack_email_tx', 'order_by': Guest.reg_ack_email_tx, 'width': '1%', 'celltoggle': 'standard', 'visible': False},
        {'name': 'R', 'data': 'reg_ack_nbr_tx', 'order_by': Guest.reg_ack_nbr_tx, 'width': '1%', 'visible': False},
        {'name': 'T', 'data': 'tsl_ack_email_tx', 'order_by': Guest.reg_ack_email_tx, 'width': '1%', 'celltoggle': 'standard', 'visible': False},
        {'name': 'T', 'data': 'tsl_ack_nbr_tx', 'order_by': Guest.tsl_ack_email_tx, 'width': '1%', 'visible': False},
        {'name': 'C', 'data': 'cancel_email_tx', 'order_by': Guest.cancel_email_tx, 'width': '1%', 'celltoggle': 'standard', 'visible': False},
        {'name': 'C', 'data': 'cancel_nbr_tx', 'order_by': Guest.cancel_nbr_tx, 'width': '1%', 'visible': False},
        {'name': 'A', 'data': 'enabled', 'order_by': Guest.enabled, 'width': '1%', 'celltoggle': 'standard', 'visible': True},
        {'name': 'T', 'data': 'email_tot_nbr_tx', 'order_by': Guest.email_tot_nbr_tx, 'orderable': True, 'celledit': 'int', 'width': '1%', 'visible': False},
    ],
